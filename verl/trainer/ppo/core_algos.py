...
def compute_grpo_outcome_advantage(
    ...
    if len(token_level_rewards.shape) == 2:
        ...
        scores = token_level_rewards.detach().clone()
...
def compute_policy_loss(
    ...
    negative_approx_kl = torch.clamp(negative_approx_kl, min=-20.0, max=20.0) # modified by ph16: https://github.com/volcengine/verl/pull/1779
...
def kl_penalty(logprob: torch.FloatTensor, ref_logprob: torch.FloatTensor, kl_penalty) -> torch.FloatTensor:
    ...
    if kl_penalty == "low_var_kl":
        ...
        kl = torch.clamp(kl, min=-20, max=20) # modified by ph16: https://github.com/volcengine/verl/pull/1779
        ratio = torch.exp(kl)

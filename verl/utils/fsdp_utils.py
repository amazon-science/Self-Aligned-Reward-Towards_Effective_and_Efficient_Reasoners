...
def get_fsdp_wrap_policy(module, config=None, is_lora=False):
    ...
    # print(f"Default transformer layer classes to wrap: {default_transformer_cls_names_to_wrap}")
    # print(f"FSDP wrap policy: {fsdp_transformer_layer_cls_to_wrap}")

    if "Gemma3" in module.__class__.__name__:
        # Gemma3 model does not support FSDP wrapping
        fsdp_transformer_layer_cls_to_wrap = ['Gemma3DecoderLayer']
        print("Warning: using Gemma3DecoderLayer as the ONLY transformer layer class to wrap. This is a temporary fix.")
    ...
    if min_num_params > 0:
        ...
        for layer_class in fsdp_transformer_layer_cls_to_wrap:
            ...
            if transformer_cls is None:
                ...
                print(f"Success: Found transformer layer class {layer_class} to wrap in the model.")
